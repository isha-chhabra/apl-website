...
const APL_PROFILES = [
  ...
  {id:'diabetes-profile-plus', name:'Diabetes Profile Plus', mrp:4000, offer:2499, fasting:true,
   tag:'Comprehensive diabetes screening package',
  ...
  {id:'cardiac-profile-advanced', name:'Cardiac Profile Advanced', mrp:6400, offer:5499, fasting:true,
  ...
  /* ---------- Fever ---------- */
  {id:'fever-profile', name:'Fever Profile', mrp:3800, offer:1900,
  ...
  {id:'fever-profile-advanced', name:'Fever Profile Advanced', mrp:4400, offer:2200,
  ...
  {id:'anemia-profile', name:'Anemia Profile', mrp:2500, offer:1850,
  ...
  {id:'hair-loss-profile', name:'Hair Loss Profile / Vitamin and Mineral Profile', mrp:3030, offer:2500,
  ...
  {id:'joint-pain-arthritis-profile', name:'Joint Pain Profile / Arthritis Profile', mrp:4780, mrpPlus:true, offer:3300,
  ...
  {id:'kidney-stone-profile', name:'Kidney Stone Profile', from:1500,
   ...
   options:[
    {name:'A) Renal Stone Analysis', mrp:2000, mrpPlus:true, offer:1500, note:'Stone sample required'},
    {name:'B) Renal Stone Profile', mrp:3760, mrpPlus:true, offer:2900}
   ],
  ...
  /* ---------- Family and Marriage ---------- */
  {id:'infertility-profile-female', name:'Infertility Profile (Female)', mrp:6200, mrpPlus:true, offer:5200,
  ...
  {id:'infertility-profile-male', name:'Infertility Profile (Male)', mrp:3900, mrpPlus:true, offer:3300,
  ...
  {id:'pre-marriage-check-up-female', name:'Pre-Marriage / Pre-Marital Check Up (Female)', mrp:2800, mrpPlus:true, offer:2500,
  ...
  {id:'pre-marriage-check-up-male', name:'Pre-Marriage / Pre-Marital Check Up (Male)', mrp:2800, mrpPlus:true, offer:2500,
   keywords:'pre marriage marital check up male men wedding hiv thalassemia',
   sections:[{tests:['Complete Blood Count (CBC)','Random Blood Sugar / Fasting Blood Sugar','SGPT','Serum Creatinine','HIV Test','HBsAg Test','HCV Test','VDRL Test','Blood Group','Haemoglobin Electrophoresis (for screening of Thalassemia, Sickle Cell Anemia and more)','Urine Complete Examination Test']}],
   notes:['All additional tests as required at 10% discount on MRP.']},

  /* ---------- Allergy ---------- */
  {id:'allergy-profile', name:'Allergy Profile', from:2000,
   ...
   options:[
    {name:'Allergy Test (Drugs Only)', offer:2000},
    {name:'Allergy Test (Veg Food Only)', offer:2100},
    {name:'Allergy Test (Veg Food + Inhalant + Contact)', offer:2600},
    {name:'Allergy Test (Veg Food + Non Veg Food + Inhalant + Contact)', offer:3700},
    {name:'Allergy Test (Veg Food, Non Veg Food + Inhalants + Contact + Drugs)', offer:4800}
   ],
