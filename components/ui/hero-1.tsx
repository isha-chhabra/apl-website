...
const defaultProps: Partial<HeroLandingProps> = {
  logo: {
    src: "https://cdn.21st.dev/assets/mirror/62/6266da6bd8587743482853fb382bd4a4dfe46e87afc8f67c6af1468ec53f0ac5.svg",
    alt: "Company Logo",
...
export function HeroLanding(props: HeroLandingProps) {
  ...
  return (
    <div className={`sm:min-h-screen w-screen overflow-x-hidden relative ${className || ''}`}>
      ...
      <header className="absolute inset-x-0 top-0 z-1">
        ...
        <Dialog open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
          <DialogContent
            ...
            className="fixed inset-y-0 left-auto right-0 z-50 h-full translate-x-0 translate-y-0 rounded-none w-full max-w-none overflow-y-auto bg-card px-4 py-4 sm:px-6 sm:py-6 sm:max-w-sm sm:ring-1 sm:ring-border lg:hidden"
          >
